        ...
        <div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-gray-800 border border-gray-700 hover:bg-gray-700 text-gray-100 transition-colors"
              title="Active Tasks"
            >
